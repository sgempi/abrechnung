define(['exports'], function (t) {
  ...
  ;(b.defaultPrecacheCacheabilityPlugin = { cacheWillUpdate: async ({ response: t }) => (!t || t.status >= 400 ? null : t) }),
    (b.copyRedirectedCacheableResponsesPlugin = { cacheWillUpdate: async ({ response: t }) => (t.redirected ? await g(t) : t) })
  class C {
    constructor({ cacheName: t, plugins: e = [], fallbackToNetwork: s = !0 } = {}) {
      ;(this.K = new Map()),
        (this.T = new Map()),
        (this.W = new Map()),
        (this.l = new b({ cacheName: u(t), plugins: [...e, new p({ precacheController: this })], fallbackToNetwork: s })),
    ...
    precache(t) {
      this.addToCacheList(t),
        this.j || (self.addEventListener('install', this.install), self.addEventListener('activate', this.activate), (this.j = !0))
    }
    addToCacheList(t) {
      const e = []
      for (const n of t) {
...
//# sourceMappingURL=workbox-e7b528f5.js.map
